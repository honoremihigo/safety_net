...
import { Plus, Edit, Trash2, X, ChevronLeft, ChevronRight, BookOpen, Tag, FileText, Search, Eye, RefreshCw, Lightbulb } from "lucide-react";
...
export default function BodyShapeTipsManagement() {
  ...
  const getCategoryColor = (category) => {
    const colors = {
      ...
      'Lifestyle': 'bg-primary-100 text-primary-800',
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-start gap-2 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className={`inline-block px-1.5 py-0.5 text-[10px] font-medium rounded-full mt-0.5 ${getCategoryColor(tip.category)}`}>
                      {tip.category}
                    </span>
                  </div>
                </div>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {currentTips.map((tip, index) => (
              <tr key={tip.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-4 py-1.5 whitespace-nowrap">
                  <span className={`inline-flex items-center gap-1 px-1.5 py-0.5 text-[10px] font-medium rounded-full ${getCategoryColor(tip.category)}`}>
                    <Tag size={10} />
                    {tip.category}
                  </span>
                </td>
      ...
      <div className="h-full overflow-y-auto mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Body Shape Tips Management</h1>
          </div>
          <p className="text-sm text-gray-600">Manage and organize tips for body shape and wellness</p>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-sm mx-4 transform transition-all duration-200">
              ...
              <form onSubmit={handleSubmit} className="p-4">
                <div className="space-y-3">
                  ...
                  <div>
                    <label htmlFor="content" className="block text-xs font-medium text-gray-700 mb-0.5">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">View complete body shape tip information</p>
                    </div>
                  </div>
                  <button
              ...
              <div className="p-4 overflow-y-auto max-h-[calc(85vh-100px)]">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <span className={`inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-lg ${getCategoryColor(selectedTip.category)}`}>
                      <Tag size={12} />
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-3">
                      <p className="text-sm text-gray-800 leading-relaxed whitespace-pre-wrap">{selectedTip.content}</p>
                    </div>
                  </div>
