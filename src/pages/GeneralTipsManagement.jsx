      ...
      <div className="h-full overflow-y-auto mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">General Tips Management</h1>
          </div>
          <p className="text-gray-600">Manage and organize general tips for various topics</p>
        </div>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">View complete general tip information</p>
                    </div>
                  </div>
                  <button
