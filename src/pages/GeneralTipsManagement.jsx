...
import { addGeneralTip, getAllGeneralTips, updateGeneralTip, deleteGeneralTip } from "../services/generalTipsService";
import { isAuthenticated } from "../services/authService";
import { useNavigate } from "react-router-dom";
import Swal from 'sweetalert2';

export default function GeneralTipsManagement() {
  ...
  const fetchTips = async (showRefreshLoader = false) => {
    ...
    try {
      const fetchedTips = await getAllGeneralTips();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingTipId) {
        await updateGeneralTip(editingTipId, { title, content });
        Swal.fire({
          icon: 'success',
          title: 'Updated!',
        ...
        await addGeneralTip({ title, content });
        Swal.fire({
          icon: 'success',
          title: 'Added!',
      ...
      <div className="h-full overflow-y-auto mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-bold text-gray-900">General Tips Management</h1>
          </div>
          <p className="text-sm text-gray-600">Manage and organize general tips for various topics</p>
        </div>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      {editingTipId ? "Update tip details" : "Create a new general tip"}
                    </p>
                  </div>
                  <button
                    onClick={closeModal}
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Share helpful general tip details..."
                      rows="4"
                    />
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">View complete general tip information</p>
                    </div>
                  </div>
                  <button
