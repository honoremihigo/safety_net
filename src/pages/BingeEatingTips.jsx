...
export default function BingeEatingTipsManagement() {
  ...
  const getCategoryColor = (category) => {
    const colors = {
      ...
      'Mental Health': 'bg-primary-100 text-primary-800',
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-start gap-2 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className={`inline-block px-1.5 py-0.5 text-[10px] font-medium rounded-full mt-1 ${getCategoryColor(tip.category)}`}>
                      {tip.category}
                    </span>
                  </div>
                </div>
    ...
    <div className="bg-gray-50 p-3 sm:p-4 lg:p-6">
      <div className="h-full overflow-y-auto mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">Manage and organize helpful tips for better health</p>
        </div>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">View complete tip information</p>
                    </div>
                  </div>
                  <button
