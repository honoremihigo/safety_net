        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-2 text-left text-[10px] font-medium text-gray-500 uppercase tracking-wider">Tip</th>
                ...
                <tr key={t.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-1.5">
                    <div className="max-w-xs">
                      <p className="text-xs text-gray-600 truncate" title={t.tip}>
                        {truncateText(t.tip, 40)}
                      </p>
                    </div>
                  </td>
                  <td className="px-4 py-1.5 whitespace-nowrap">
      ...
      <div className="h-full overflow-y-auto mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Depression Tips Management</h1>
          </div>
          <p className="text-sm text-gray-600">Manage and organize tips for supporting mental health</p>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-sm mx-4 transform transition-all duration-200">
              ...
              <form onSubmit={handleSubmit} className="p-4">
                <div className="space-y-3">
                  ...
                  <div>
                    <label htmlFor="tip" className="block text-xs font-medium text-gray-700 mb-0.5">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">View complete depression tip information</p>
                    </div>
                  </div>
                  <button
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-3">
                      <p className="text-sm text-gray-800 leading-relaxed whitespace-pre-wrap">{selectedTip.tip || 'No tip available'}</p>
                    </div>
                  </div>
