...
export default function FailingTipsManagement() {
  ...
  const fetchTips = async (showRefreshLoader = false) => {
    ...
    try {
      const fetchedTips = await getAllFailingTips();
      setTips(fetchedTips);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingTipId) {
        await updateFailingTip(editingTipId, { title, content });
        Swal.fire({
          icon: 'success',
          title: 'Updated!',
        ...
        await addFailingTip({ title, content });
        Swal.fire({
          icon: 'success',
          title: 'Added!',
